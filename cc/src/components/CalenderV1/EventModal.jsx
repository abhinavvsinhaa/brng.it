      ...
      <form className="bg-white rounded-lg shadow-2xl w-1/3">
        ...
        <header className="bg-gray-100 px-4 py-2 flex justify-between items-center">
          ...
          <div className="flex">
            {selectedEvent && (
              <svg
                xmlns="http://www.w3.org/2000/svg"
                className="h-6 w-6 mr-3 inline-block hover:cursor-pointer"
                fill="none"
                viewBox="0 0 24 24"
                stroke="currentColor"
                strokeWidth={2}
        ...
        <div className="p-3">
          <div className="grid grid-cols-1 items-end gap-y-7">
            ...
            <input
              ...
              value={title}
              required
              className="pt-3 border-0 text-gray-600 text-lg font-semibold pb-2 w-full border-gray-200 focus:outline-none focus:ring-0 focus:border-blue-500"
        ...
        <footer className="flex justify-end border-t p-3 mt-5">
          <button
            ...
            className="bg-blue-500 hover:bg-blue-600 px-6 py-2 rounded text-white text-14px"
          >
            Share Now
          </button>
          <button
            type="submit"
            onClick={handleSubmit}
            className="bg-blue-500 hover:bg-blue-600 mx-2 px-6 py-2 rounded text-white text-14px"
          >
            Schedule
          </button>
        </footer>
