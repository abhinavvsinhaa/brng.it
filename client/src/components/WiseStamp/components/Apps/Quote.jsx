            ...
            <div className="grid grid-rows-[1fr_2fr_7fr]">
                ...
                <div className="grid grid-rows-[30px_auto] gap-[10px]">
                    ...
                    <div className="grid grid-rows-[20px_20px_20px_20px_20px_20px] grid-cols-[1fr_1fr] gap-[10px]">
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="conf" id="conf" checked={quoteType==='success'?true:false} onClick={()=>{setquoteType('success')}}/></div><div>Success</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="vir" id="vir" checked={quoteType==='motivational'?true:false} onClick={()=>{setquoteType('motivational')}}/></div><div>Motivational</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="nbrand" id="nbrand" checked={quoteType==='william'?true:false} onClick={()=>{setquoteType('william')}}/></div><div>William Shakespare</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="po" id="po" checked={quoteType==='science'?true:false} onClick={()=>{setquoteType('science')}}/></div><div>Science</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="cr" id="cr" checked={quoteType==='finance'?true:false} onClick={()=>{setquoteType('finance')}}/></div><div>Finance</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="custom" id="custom" checked={quoteType==='random'?true:false} onClick={()=>{setquoteType('random')}}/></div><div>Random</div></div>
                    </div>
                </div>
