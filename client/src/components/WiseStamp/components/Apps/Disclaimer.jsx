            ...
            <div className="grid grid-rows-[1fr_auto_7fr]">
                ...
                <div className="grid grid-rows-[30px_auto] gap-[10px]">
                    ...
                    <div className="grid grid-rows-[20px_20px_20px_20px_20px_20px] gap-[10px]">
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="conf" id="conf" checked={disclaimer===0?true:false} onClick={()=>{setDisclaimerIndex(0)}}/></div><div>Confidelity</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="vir" id="vir" checked={disclaimer===1?true:false} onClick={()=>{setDisclaimerIndex(1)}}/></div><div>No viruses</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="nbrand" id="nbrand" checked={disclaimer===2?true:false} onClick={()=>{setDisclaimerIndex(2)}}/></div><div>Non-branding</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="po" id="po" checked={disclaimer===3?true:false} onClick={()=>{setDisclaimerIndex(3)}}/></div><div>Personal Opinions</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="cr" id="cr" checked={disclaimer===4?true:false} onClick={()=>{setDisclaimerIndex(4)}}/></div><div>Correct Receipent</div></div>
                        <div className="grid grid-cols-[auto_1fr] gap-[10px] place-content-center"><div className="grid place-content-center"><input type="radio" name="custom" id="custom" checked={disclaimer===5?true:false} onClick={()=>{setDisclaimerIndex(5)}}/></div><div>Custom</div></div>
                    </div>
                </div>
