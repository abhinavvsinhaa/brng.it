    ...
    return(
        ...
        <div className="grid grid-rows-[auto_auto]">
            <div className="grid grid-rows-[1fr_4fr] gap-[5px]">
                ...
                <div className="grid grid-cols-[1fr_1fr] gap-[5px] h-fit">
                    <div className="cursor-pointer grid grid-flow-col place-self-center h-[50px] w-[90%] shadow-[rgba(0,_0,_0,_0.02)_0px_1px_3px_0px,_rgba(27,_31,_35,_0.15)_0px_0px_0px_1px] rounded bg-[#f8f9fb]" onClick={() => {setVisible(true);setwhichDrawer('signoff')}}>
                    ...
                    <div className="cursor-pointer grid grid-flow-col place-self-center h-[50px] w-[90%] shadow-[rgba(0,_0,_0,_0.02)_0px_1px_3px_0px,_rgba(27,_31,_35,_0.15)_0px_0px_0px_1px] rounded bg-[#f8f9fb]" onClick={() => {setVisible(true);setwhichDrawer('disclaimer')}}>
                        <div className="grid grid-cols-[auto_1fr] place-self-center gap-[8px]">
