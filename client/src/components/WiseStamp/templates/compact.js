...
export default function CompactTemplate({variableInput}){
    return(
        <div style={{padding: "30px",display:'grid',gridTemplateRows:'auto auto',width:'635px'}}>
                    ...
                    <div style={{display:'grid',gridAutoFlow:'column','gap':'8px','paddingRight':'8px','width':'fit-content','paddingTop':'10px'}}>
                        {
                           variableInput.fb === ""?'':<a href={`https://www.facebook.com/${variableInput.fb}`}>
                           <div style={{background:'#45668E',border:'1px solid white',borderRadius:'999px',width:'24px',height:'24px',display:'grid'}}>
